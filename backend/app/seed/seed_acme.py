...
SCENARIO_FIXTURES = [
    ...
    ScenarioFixture(
        ...
        month="2026-05",
        prompt="Beta Robotics says its May 2026 invoice used the wrong overage rate.",
        expected_outcome="invoice_incorrect",
    ...
    ScenarioFixture(
        ...
        month="2026-04",
        prompt="CloudCart says its April 2026 invoice ignored its included API calls.",
        expected_outcome="invoice_incorrect",
    ...
    ScenarioFixture(
        ...
        month="2026-02",
        prompt="Echo Health says its February 2026 invoice shows more usage than records.",
        expected_outcome="invoice_incorrect",
    ...
    ScenarioFixture(
        ...
        month="2026-01",
        prompt="Fairwind Labs asks whether its January 2026 invoice is correct.",
    ...
    ScenarioFixture(
        ...
        month="2026-06",
        prompt="Granite Analytics says its June 2026 invoice includes repeated usage.",
        expected_outcome="invoice_incorrect",
        hidden_cause="duplicate_usage_events",
    ...
    ScenarioFixture(
        ...
        month="2026-05",
        prompt="Helio Maps says its May 2026 invoice double-counted a usage import.",
        expected_outcome="invoice_incorrect",
        hidden_cause="duplicate_usage_events",
    ...
    ScenarioFixture(
        ...
        month="2026-04",
        prompt="Ion Security says its April 2026 invoice includes duplicated API events.",
        expected_outcome="invoice_incorrect",
        hidden_cause="duplicate_usage_events",
    ...
    ScenarioFixture(
        ...
        month="2026-03",
        prompt="Jupiter Supply says its March 2026 overage rate is higher than contract.",
        expected_outcome="invoice_incorrect",
        hidden_cause="overage_rate_mismatch",
        included_api_calls=100_000,
        overage_rate_cents=5,
    ...
    ScenarioFixture(
        ...
        month="2026-02",
        prompt="Keystone Legal says its February 2026 invoice used a rate from the wrong plan.",
        expected_outcome="invoice_incorrect",
        hidden_cause="overage_rate_mismatch",
        included_api_calls=200_000,
        overage_rate_cents=3,
    ...
    ScenarioFixture(
        ...
        month="2026-01",
        prompt="Lumen Retail says its January 2026 overage was priced above contract.",
        expected_outcome="invoice_incorrect",
        hidden_cause="overage_rate_mismatch",
        included_api_calls=50_000,
    ...
    ScenarioFixture(
        ...
        month="2026-06",
        prompt="Meridian Bio says its June 2026 invoice charged all usage, not just overage.",
        expected_outcome="invoice_incorrect",
        hidden_cause="included_allowance_not_applied",
    ...
    ScenarioFixture(
        ...
        month="2026-05",
        prompt="Northstar CRM says its May 2026 invoice did not subtract included calls.",
        expected_outcome="invoice_incorrect",
        hidden_cause="included_allowance_not_applied",
    ...
    ScenarioFixture(
        ...
        month="2026-04",
        prompt="Orchid Finance says it was billed overage while under its April allowance.",
        expected_outcome="invoice_incorrect",
        hidden_cause="below_allowance_overage_charged",
        included_api_calls=250_000,
        overage_rate_cents=2,
    ...
    ScenarioFixture(
        ...
        month="2026-03",
        prompt="Pioneer EdTech says its March 2026 invoice charged overage below allowance.",
        expected_outcome="invoice_incorrect",
        hidden_cause="below_allowance_overage_charged",
    ...
    ScenarioFixture(
        ...
        month="2026-02",
        prompt="Quartz Media says its February 2026 invoice has more calls than usage logs.",
        expected_outcome="invoice_incorrect",
        hidden_cause="invoice_usage_exceeds_recorded_usage",
        included_api_calls=100_000,
        overage_rate_cents=4,
    ...
    ScenarioFixture(
        ...
        month="2026-01",
        prompt="RiverOps says its January 2026 invoice includes usage not in records.",
        expected_outcome="invoice_incorrect",
        hidden_cause="invoice_usage_exceeds_recorded_usage",
    ...
    ScenarioFixture(
        ...
        month="2026-06",
        prompt="Summit Travel asks whether its June 2026 invoice matches contract terms.",
        expected_outcome="invoice_correct",
        hidden_cause="no_issue_found",
        included_api_calls=200_000,
        overage_rate_cents=3,
    ...
    ScenarioFixture(
        ...
        month="2026-05",
        prompt="Terra Foods asks whether its May 2026 invoice is correct.",
        expected_outcome="invoice_correct",
        hidden_cause="no_issue_found",
        included_api_calls=100_000,
        overage_rate_cents=4,
